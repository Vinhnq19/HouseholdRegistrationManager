...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>Vietnamese Public Services - Tổ trưởng tổ dân phố</title>
        ...
        <div id="pageWrapper" class="ltr">
            ...
            <main>
                ...
                <div class="introBlock ibSlider">
                    <jsp:include page="../leader/ibSlider.jsp"></jsp:include>
                </div>
                
                <!-- Features -->
                <aside id="featuresAsideBlock" class="featuresAsideBlock position-relative text-white">
                    <jsp:include page="../leader/featuresAsideBlock.jsp"></jsp:include>
                </aside>
